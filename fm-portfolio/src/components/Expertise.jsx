    ...
    <div className='flex justify-center items-center py-12 p-4'>
      <div className='flex flex-col lg:gap-6 gap-3' >
        ...
        <div className='flex justify-center items-start lg:gap-6 gap-3 flex-wrap'>
          ...
          {/* Streak Graph */}
          <img src="https://streak-stats.demolab.com?user=fwedwicc&theme=material-palenight&currStreakNum=C1B1FF&background=1C182D&border=40317A&currStreakLabel=C1B1FF&fire=F1E05A&ring=C693EA&dates=FFFFFF&sideNums=C1B1FF&sideLabels=C1B1FF&stroke=AF84FF36" className='h-[12rem] w-auto' alt="streak graph" />
        </div>
        {/* Contribution Graph */}
...
const Certifications = () => {
  return (
    ...
    <div className='flex flex-col gap-12 lg:h-screen items-center justify-center'>
