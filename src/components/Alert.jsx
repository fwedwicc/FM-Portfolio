...
const Alert = () => {
  return (
    <div className='hidden md:block w-full max-w-[15rem] bg-yellow-500/20 border-yellow-500/30 text-yellow-300/70 backdrop-blur-md rounded-md border p-3 fixed right-4 top-4 space-y-1.5 z-50'>
